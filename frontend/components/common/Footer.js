...
const Footer  = () =>{
    return(
        <>
            <div className="bg-gray-900 border-t-[6] rounded-t-sm border-indigo-700">
                <div className="max-w-2xl mx-auto text-white py-10">
                    <div className="text-center">
                        <h3 className="text-3xl mb-3"> Download our LinkedLens </h3>
                        <p className="text-gray-400"> "Coming Soon" </p>
                        <p> Stay Professional. All day, every day. </p>
                    ...
                    <div className="mt-28 flex flex-col md:flex-row md:justify-between items-center text-sm text-gray-400">
                        <p className="order-2 md:order-1 mt-8 md:mt-0"> &copy; LinkedLense, 2025. </p>
